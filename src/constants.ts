...
export const PRODUCTS: Product[] = [
  {
    ...
    long_description: 'The Nairobi NightClutch is more than just an accessory; it\'s a statement. Crafted from premium Kenyan leather, it features a unique beadwork pattern on the interior lining, a nod to traditional Maasai craftsmanship. Perfect for an evening out at Westlands or a sophisticated dinner in Karen.',
    price: 4500,
    category: 'Clutches',
    image_url: 'https://images.unsplash.com/photo-1594223274512-ad4803739b7c?auto=format&fit=crop&q=80&w=1000',
    gallery: [
  ...
  },
  {
    ...
    long_description: 'Whether you\'re heading to the office or a weekend getaway to the Mara, the Savannah Tote is your reliable companion. Its robust canvas body is reinforced with high-quality leather handles and base, ensuring durability without compromising on style. Features multiple internal pockets for organized storage.',
    price: 6800,
    category: 'Totes',
    image_url: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?auto=format&fit=crop&q=80&w=1000',
    gallery: [
  ...
  },
  {
    ...
    long_description: 'Inspired by the breathtaking landscapes of the Great Rift Valley, this satchel combines ruggedness with refined design. The adjustable shoulder strap allows for comfortable cross-body wear, while the secure brass buckles keep your essentials safe. A timeless piece that ages beautifully.',
    price: 8500,
    category: 'Satchels',
  ...
  },
  {
    ...
    long_description: 'Bring a piece of the coast to the city with the Lamu Luxury Bucket. Hand-woven by artisans in Lamu, the palm leaf body is paired with supple leather for a sophisticated look. Its drawstring closure ensures your belongings are safe while maintaining a relaxed, coastal aesthetic.',
    price: 5500,
    category: 'Bucket',
    image_url: 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?auto=format&fit=crop&q=80&w=1000',
    gallery: [
  ...
  },
  {
    ...
    long_description: 'The Mombasa Weekender is the ultimate travel companion. Its spacious interior can easily accommodate all your essentials for a 3-day trip, while the reinforced handles and detachable shoulder strap provide multiple carrying options. Crafted from premium leather that only gets better with time.',
    price: 12000,
    category: 'Weekender',
...
export const JOURNAL_ARTICLES: BlogPost[] = [
    {
        id: '1',
        ...
        image_url: "https://images.unsplash.com/photo-1524289286702-f07229da36f5?auto=format&fit=crop&q=80&w=1000",
        author_id: 'admin',
        content: `
            <p className="mb-6 first-letter:text-5xl first-letter:font-serif first-letter:mr-3 first-letter:float-left text-[#5D5A53]">
            ...
            <blockquote className="border-l-2 border-[#2C2A26] pl-6 italic text-xl text-[#2C2A26] my-10 font-serif">
                "Quality is not an act, it is a habit. At Mel's Fashion, it is our way of life."
            </blockquote>
            <p className="mb-6 text-[#5D5A53]">
    ...
    },
    {
        ...
        image_url: "https://images.unsplash.com/photo-1583209814683-c023dd293cc6?auto=format&fit=crop&q=80&w=1000",
        author_id: 'admin',
        content: `
            <p className="mb-6 text-[#5D5A53]">
            ...
            <div className="my-12 p-8 bg-[#EBE7DE] font-serif text-[#2C2A26] italic text-center">
                <p>The city hums</p>
                <p>With a rhythm all its own.</p>
                <p>From the bustling CBD</p>
                <p>To the quiet of the suburbs.</p>
                <p>Mel's Fashion fits</p>
                <p>Every beat of the heart.</p>
            </div>
            <p className="mb-6 text-[#5D5A53]">
    ...
    },
    {
        ...
        image_url: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=1000",
        author_id: 'admin',
        content: `
            <p className="mb-6 text-[#5D5A53]">
            ...
            <p className="mb-8 text-[#5D5A53]">
             ...
             <div className="my-12 p-8 bg-[#2C2A26] text-[#F5F2EB] font-serif italic text-center">
                <p>Buy less, choose well</p>
                <p>Make it last.</p>
                <p>The future is slow.</p>
            </div>
        `
    }
];
